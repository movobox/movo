export default {
  ...
  placeholder: "Ask Oxpin to do something...",
  ...
  watcherHint: "Track project changes while Oxpin works.",
  ...
  emptyTitle: "What can Oxpin build for you?",
  ...
  interruptedDetail: "Operation failed after {attempt}/{max} attempts.",
  resume: "Resume",
